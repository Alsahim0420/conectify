...
void main() {
  ...
  group('Conectify Example App Integration Tests', () {
    testWidgets('App inicia y muestra la pantalla de productos', (
      WidgetTester tester,
    ) async {
      app.main();
    ...
    testWidgets('App muestra indicador de carga inicial', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pump();
    ...
    testWidgets('App carga y muestra productos después de la carga', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pump();
    ...
    testWidgets('App tiene botón de refresh funcional', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    testWidgets('App muestra categorías cuando están disponibles', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    testWidgets('App maneja errores de red correctamente', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('App puede navegar a detalle de producto', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    testWidgets('Pantalla de detalle muestra información del producto', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    testWidgets('App puede volver desde detalle a lista', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 5));
